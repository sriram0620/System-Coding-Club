...
import { BrainCircuit as Circuit, Code2, Cpu, Database, Rocket, Users, Github, Linkedin, Twitter, Menu, X, Trophy, Medal,Microchip,Waves, Star, Award } from 'lucide-react';
  ...
  const wings = [
    {
      name: "Verilog",
      icon: Circuit,
      description: "Digital design and FPGA programming for hardware implementation",
      projects: "25+",
      members: "80+"
    },
    {
      ...
      icon: Microchip,
      description: "IoT, microcontrollers, and real-time systems development",
      projects: "30+",
      members: "100+"
    },
    {
      name: "MATLAB",
      icon: Waves,
      description: "Industrial automation and signal processing solutions",
      projects: "20+",
      members: "70+"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4">
        <div className="text-center z-10">
          ...
          >
            <a href="#events" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-full transition-all duration-300 transform hover:scale-105">
              Join Events
            </a>
            <a href="#about" className="px-8 py-3 border border-blue-500 rounded-full hover:bg-blue-500/20 transition-all duration-300 transform hover:scale-105">
              Learn More
            </a>
          </motion.div>
        </div>
      ...
      <section className="relative py-10 px-4" ref={introRef}>
      ...
      {/* Club Wings Section */}
      <section id="about" className="relative py-20 px-4 bg-gradient-to-r from-blue-900/20 to-purple-900/20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16">Our Wings</h2>
            ...
            {wings.map((wing, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <wing.icon className="w-12 h-12 text-blue-500 mb-4" />
                  <h3 className="text-2xl font-bold mb-2">{wing.name}</h3>
                  <p className="text-gray-400 mb-6">{wing.description}</p>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-blue-500/10 rounded-lg">
                      <div className="text-xl font-bold text-blue-400">{wing.projects}</div>
                      <div className="text-sm text-gray-400">Projects</div>
                    </div>
                    <div className="text-center p-3 bg-blue-500/10 rounded-lg">
                      <div className="text-xl font-bold text-blue-400">{wing.members}</div>
